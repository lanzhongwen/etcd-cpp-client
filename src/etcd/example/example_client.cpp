...
{
      ///////////////////////////Client//////////////////////////////////////////////
      // Client support only one key per client NOT support multiple key registration
      {
...

      {
            ...
            {
                  etcd::Client client("127.0.0.1:2379");
                  const std::string key("/lzw/test/register");
                  const std::string value("I'm happy too");
                  int64_t ttl = 5;
                  if (client.Register(key, value, ttl) == false)
                  {
